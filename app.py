...
# Connect to MongoDB
client = MongoClient('mongodb://localhost:27017/')  # Adjust the URI according to your MongoDB setup
db = client['sample_excel']  # Replace 'your_database_name' with your actual database name
collection = db['sample_files']  # Replace 'your_collection_name' with your actual collection name
...
#     fcar
   ...
   # Insert data into MongoDB
    example_data = {
        'IAT1': IAT1.to_dict(orient='list'),
        'IAT2': IAT2.to_dict(orient='list'),
        'Direct': df.to_dict(orient='list'),
        'Indirect': indirect.to_dict(orient='list')
    }
    collection.insert_one(example_data)

    # Example: Querying data from MongoDB
